class Subject{
    ...
    constructor( code, name, profName, duration, position, color = 'gray'){
        this.code = code,
        this.name = name,
        this.profName = profName,
        this.subjectLength = duration,
        this.subjectTime = position,
        this.subjectColor = color
    }

    get subjectDuration(){
        return this.subjectLength * 4;
    }
    get subjectPosition(){
        return this.subjectTime * 4;
    }
